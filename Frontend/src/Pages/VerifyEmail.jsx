    ...
    return(
        <div className="min-h-[calc(100dvh-4.5rem)] px-[2rem] py-[2rem] mt-[4.5rem] flex justify-center items-center">
            <div className="flex-col justify-items-center max-w-[350px] sm:max-w-[300px]">
                ...
                <div className="text-white font-semibold text-center text-base mt-[2rem]">
                    Didn't receive the code? <button disabled={isRunning} onClick={handleClick} className="text-[#b1e50e] underline cursor-pointer">
