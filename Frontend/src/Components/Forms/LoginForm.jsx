        ...
        <div className="mt-[3rem] flex justify-center w-[100%]">
            <form className="w-[100%]" onSubmit={handleSubmit}>
                <div>
                    ...
                    <input id="password" type="password" minLength="8" maxLength="64" value={formData.password} onChange={handleChange} placeholder="Enter password" className="font-semibold text-base bg-[#151b23] border-b border-[#b1e50e] outline-none text-white mt-[0.5rem] w-[100%] py-[0.8rem] rounded-md indent-3"></input>
                </div>

                <div className="flex justify-end mt-[0.5rem]">
                    <Link to="/forgot-password" onClick={() => window.scrollTo(0, 0)}>
                        <button type="button" className="font-semibold text-base text-[#b1e50e]">
                            Forgot password
                        </button>
                    </Link>
                </div>
                ...
                <button 
                    type="submit" 
                    disabled={isRunning}
                    className="w-[100%] bg-[#b1e50e] mt-[2rem] py-[0.8rem] font-semibold text-base rounded-lg cursor-pointer">
