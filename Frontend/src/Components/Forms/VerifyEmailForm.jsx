        ...
        <div className="mt-[2rem] flex justify-center w-[100%]">
            <form className="w-[100%]" onSubmit={handleSubmit}>
                <div>
                    ...
                    <p className="font-semibold text-sm text-white text-center mt-[0.5rem]">
                        (Make sure to check Spam folder too)
                    </p>

                    <input id="code" type="password" minLength="6" maxLength="6" value={formData.code} onChange={handleChange} placeholder="6-digit code" className="font-medium text-base bg-[#151b23] border-b border-[#b1e50e] outline-none text-white mt-[2rem] mb-[1rem] w-[100%] py-[0.8rem] rounded-md indent-3"></input> <br/>
                </div>
